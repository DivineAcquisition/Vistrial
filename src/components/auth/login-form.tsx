...
export function LoginForm({ onSubmit, redirectUrl }: LoginFormProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // If no error, the browser will redirect to Google OAuth
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full h-11 border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium shadow-sm"
