  ...
  if (bookings.length === 0) {
    return (
      <div className="relative">
        ...
        <div className="relative bg-white rounded-2xl border border-gray-200 p-12 text-center">
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <span className="text-gray-900">{booking.service_types.name}</span>
                      {booking.memberships && (
                  ...
                  <td className="px-4 py-3">
                    <div className="text-gray-900">{booking.address_line1}</div>
          ...
          {bookings.map((booking) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <span className="font-medium text-gray-900">{formatCurrency(booking.total)}</span>
              </div>
            </Link>
          ))}
        </div>
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 bg-gray-50">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 border border-gray-200 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 transition-colors"
              >
