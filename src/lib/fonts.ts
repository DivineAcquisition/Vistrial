...
/**
 * Inter Display across every face: landing, auth, and the operator app.
 * The variable files include the opsz axis; locking it to 32 in the
 * @font-face is the Display cut at every size.
