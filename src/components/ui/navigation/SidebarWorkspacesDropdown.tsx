    ...
    <>
      ...
      >
        <DropdownMenuTrigger asChild>
          ...
          >
            <span
              className="flex aspect-square size-8 items-center justify-center rounded bg-brand-600 p-2 text-xs font-medium text-white dark:bg-brand-400"
              aria-hidden="true"
            >
              RA
            </span>
      ...
      >
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-x-1.5 rounded-md p-2 hover:bg-gray-100 focus:outline-none hover:dark:bg-gray-900">
            <span
              className={cx(
                "flex aspect-square size-7 items-center justify-center rounded bg-brand-600 p-2 text-xs font-medium text-white dark:bg-brand-400",
              )}
              aria-hidden="true"
            >
              RA
