...
| **GoHighLevel (HighLevel)** | CRM + messaging | Contacts, messages, appointments. Vistrial stores encrypted OAuth tokens and inbound webhook payloads (short retention). | HighLevel |
