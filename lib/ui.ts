/**
 * Shared class recipes, ported from the Divine Acquisition repo. #9A88FC
 * (brand-500) is the prime action colour; it is light enough that near-black
 * label text reads far better on it than white, which is why primary buttons
 * invert their type.
 */
...
export const labelClass =
  "mb-1.5 block text-[11px] font-semibold uppercase tracking-[0.12em] text-neutral-500";
