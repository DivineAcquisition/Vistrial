          ...
          <div className="space-y-3">
            {step.type === "sms" && (
              <textarea
                ...
                className="w-full px-3 py-2 bg-gray-900 border border-white/10 rounded-lg text-white resize-none text-sm"
              />
            )}
            {step.type === "voice" && (
              <textarea
            ...
            {step.type === "delay" && (
              <div className="flex items-center gap-3">
                <input
                  ...
                  min={1}
                  className="w-20 px-3 py-2 bg-gray-900 border border-white/10 rounded-lg text-white text-sm"
                />
                <select
                  value={editedStep.delay_unit || "days"}
                  onChange={(e) => setEditedStep({ ...editedStep, delay_unit: e.target.value as any })}
                  className="px-3 py-2 bg-gray-900 border border-white/10 rounded-lg text-white text-sm"
                >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        {showAddMenu && (
          <div className="absolute top-full left-0 right-0 mt-2 p-2 bg-gray-800 border border-white/10 rounded-xl shadow-xl z-10">
