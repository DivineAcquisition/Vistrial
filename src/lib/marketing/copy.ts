...
export const SITE_DESCRIPTION =
  "Sits on top of GoHighLevel. Vistrial is a case-file layer: every lead gets a readiness score, full contact history, what was said on the last call, and follow-up written from it. Nothing to migrate.";
...
export const GHL = {
  headline: "Runs on GoHighLevel. Nothing to migrate.",
  body: "GoHighLevel stays your system of record. Your conversations, your calendar, your pipeline, your automations: unchanged. Vistrial reads from it, adds the layer it does not have, and sends through it. One click to connect. Nothing to rebuild, nothing to retrain your team on from scratch.",
