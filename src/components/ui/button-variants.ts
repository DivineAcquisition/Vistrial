    ...
    variants: {
      ...
      variant: {
        ...
        primary:
          "not-disabled:inset-shadow-[0_1px_--theme(--color-white/16%)] border-primary bg-primary text-primary-foreground shadow-primary/24 shadow-xs hover:bg-primary/90 data-pressed:bg-primary/90 *:data-[slot=button-loading-indicator]:text-primary-foreground [:active,[data-pressed]]:inset-shadow-[0_1px_--theme(--color-black/8%)] [:disabled,:active,[data-pressed]]:shadow-none",
        gradient:
          "not-disabled:inset-shadow-[0_1px_--theme(--color-white/16%)] border-primary bg-linear-to-b from-brand-400 via-brand-500 to-brand-600 text-primary-foreground shadow-primary/24 shadow-xs hover:from-brand-300 hover:via-brand-400 hover:to-brand-500 data-pressed:from-brand-400 data-pressed:via-brand-500 data-pressed:to-brand-600 *:data-[slot=button-loading-indicator]:text-primary-foreground [:active,[data-pressed]]:inset-shadow-[0_1px_--theme(--color-black/8%)] [:disabled,:active,[data-pressed]]:shadow-none",
        destructive:
