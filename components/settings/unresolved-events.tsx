...
function EventCard({
  ...
  return (
    <Panel as="li" className="px-5 py-4">
      ...
      <details className="mt-3 rounded-xl border border-white/[0.06] bg-white/[0.02]">
        <summary className="cursor-pointer px-3.5 py-2.5 text-sm text-neutral-400 select-none">
          Payload
        </summary>
        <pre className="max-h-72 overflow-auto border-t border-white/[0.06] px-3.5 py-3 text-xs leading-relaxed text-neutral-400">
          {event.payload}
        </pre>
      </details>
