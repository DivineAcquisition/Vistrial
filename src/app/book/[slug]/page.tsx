/**
 * Public Booking Page
 * Full-page booking experience at book.vistrial.io/[slug]
 */
...
export async function generateMetadata({ params }: BookPageProps) {
  ...
  return {
    title: profile?.business_name 
      ? `Book with ${profile.business_name} | Vistrial`
      : "Book Your Cleaning | Vistrial",
    description: "Book your cleaning service online. Quick, easy, and convenient.",
  }
}
