...
export const segmentedControlItemSizeClassNames: Record<
  ...
  string
> = {
  default: "h-8.5 px-[calc(--spacing(2.5)-1px)] sm:h-8",
  lg: "h-9.5 px-[calc(--spacing(3)-1px)] sm:h-8.5",
  sm: "h-7.5 px-[calc(--spacing(2)-1px)] sm:h-6.5",
};

export const segmentedControlRootClassName =
  "relative z-0 flex w-fit items-center justify-center gap-0.5 rounded-xl border border-border bg-muted/70 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] dark:border-white/[0.06] dark:bg-white/[0.04] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]";
