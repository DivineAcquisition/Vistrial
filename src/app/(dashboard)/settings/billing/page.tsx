    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500">$49/month · Renews on Feb 28, 2026</p>
          </div>
          <button className="px-4 py-2 bg-brand-600 text-gray-900 rounded-xl font-medium hover:bg-brand-700 transition-colors">
            Upgrade Plan
          </button>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {plans.map((plan) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-brand-600 text-gray-900 text-xs font-medium rounded-full">
                  Most Popular
                </div>
              )}
              {plan.current && (
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-sm">Expires 12/2028</p>
          </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-gray-900">Auto-Refill Credits</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select className="w-full px-3 py-2.5 bg-gray-800 border border-gray-200 rounded-xl text-gray-900">
          ...
          <div className="flex items-end">
            <button className="w-full py-2.5 bg-brand-600 text-gray-900 rounded-xl font-medium hover:bg-brand-700 transition-colors">
              Enable Auto-Refill
            </button>
          </div>
        </div>
