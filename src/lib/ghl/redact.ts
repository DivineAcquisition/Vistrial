const SENSITIVE_KEY =
  /^(access_token|refresh_token|token|client_secret|authorization|password|body|message|html|text|email|phone|firstName|lastName|first_name|last_name|from|to|attachments|raw|rawBody|content)$/i;
